...
const RightArrow: FC<{ onClick: ReactEventHandler }> = ({ onClick }) => (
  <button
    type="button"
    className="absolute right-0 z-30 flex items-center justify-center w-16 h-24 bg-black rounded-r-lg shadow bg-opacity-50 hover:shadow-outline transition ease-in-out duration-200"
    onClick={onClick}
  >
